...
% internally)
% * <mesh2poly_help.html |mesh2poly|> - Converts a mesh to shapefile
% structure
% * <msim_compile_help.html |msim_compile|> - Compiles the C/C++ functions
% * <msim_mesh_options_help.html |msim_mesh_options|> - Default mesh
% options
% * <msim_polysplit_help.html |msim_polysplit|> - reimplementation of
% polysplit
% * <msim_root_help.html |msim_root|> - returns the root folder of the msim
% * <poly2mesh_help.html |mesh2poly|> - Converts a shapefile structure to
% element mesh
...
% * <WriteAscii4Raster_help.html |WriteAscii4Raster|> - Writes Data to
% ASCII ARCGIS fromat
